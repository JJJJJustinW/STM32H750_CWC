...
int main(void) {
    ...
    while (1) {
        ...
        if (AD_State == ADDA_STATE_IDLE) {
            ...
            Screen_SendStr("res.txt=\"",FB_OFF);
            switch (ftype) {
                case FILTER_LOW_PASS:
                    Screen_SendStr("lowpass",FB_OFF);
                    break;
                case FILTER_HIGH_PASS:
                    Screen_SendStr("highpass",FB_OFF);
                    break;
                case FILTER_BAND_PASS:
                    Screen_SendStr("bandpass",FB_OFF);
                    break;
                case FILTER_BAND_STOP:
                    Screen_SendStr("bandstop",FB_OFF);
                    break;
                case FILTER_UNKNOWN:
                    Screen_SendStr("UNKNOWN",FB_OFF);
                    break;
                default: ;
            }
            Screen_SendStr("\"\xFF\xFF\xFF\r\n",FB_OFF);
            Screen_SendStr("ls.val=1\xFF\xFF\xFF\r\n",FB_OFF);
